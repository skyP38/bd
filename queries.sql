...
SELECT
    ...
    COALESCE(cc.cnts, 0)  AS contracts
FROM client c
...
SELECT
    TO_CHAR(md.month_start, 'Month YYYY') AS "YYYY-MM",
...
ORDER BY md.month_start;
    ...
    YYYY-MM     | unpaid cnt | paid cnt |  all cnt  | nmb cnt/month | amt cnt/month | nmb ipd/month | amt ipd/month | nmb opd
/month | amt opd/month | unpaid cnt m end | monthly profit
----------------+------------+----------+-----------+---------------+---------------+---------------+---------------+--------
-------+---------------+------------------+----------------
 July      2025 |     452500 |    60000 |    565000 |             2 |        150000 |
4 |         63300 |             3 |         38250 |           569200 |          25050
 August    2025 |     569200 |    60000 |    715000 |             1 |         45000 |             4 |         98000 |             3 |         52600 |           546200 |          45400
 September 2025 |     546200 |    60000 |    760000 |             2 |         85000 |             3 |         82000 |             3 |         80900 |           549200 |           1100
 October   2025 |     549200 |   110000 |    845000 |             1 |        120000 |             2 |         18600 |             3 |         35140 |           650600 |         -16540
 November  2025 |     650600 |   110000 |    965000 |             2 |        115000 |             2 |         19000 |             1 |          9000 |           746600 |          10000
 December  2025 |     746600 |   110000 |  1.08e+06 |             0 |             0 |             2 |         35000 |             3 |         26600 |           711600 |           8400
 January   2026 |     711600 |   110000 |  1.08e+06 |             2 |        245000 |             1 |          6000 |             1 |          5400 |           950600 |            600
 February  2026 |     950600 |   110000 | 1.325e+06 |             2 |        115000 |             2 |         26000 |             2 |         23400 |       1.0396e+06 |           2600
 March     2026 | 1.0396e+06 |   110000 |  1.44e+06 |            12 |        792000 |             3 |         18000 |             3 |         16200 |       1.8136e+06 |           1800
(9 rows)
...
WITH temp AS (
    SELECT
        ...
        d.full_name,
        cnt.contract_number,
        cnt.debt_amount / COUNT(*) OVER (PARTITION BY cnt.contract_number) AS debt_amount,
        pd.date,
...
SELECT
    ...
    da.overdue_cnt AS "cnt overdue",
    da.overdue_amt AS "amt overdue",

    -- количество и сумма пунктов плана платежей, дата оплаты которых еще не истекла;
    da.future_cnt AS "cnt future",
    da.future_amt AS "amt future",
...
FROM debtor_agg da;
 ...
 debtor_id |       debtor name       | total debt | oldest date | oldest sum | cnt overdue | amt overdue | cnt future | amt future | % paid | % unpaid | % overdue | % not overdue
-----------+-------------------------+------------+-------------+------------+-------------+-------------+------------+------------+--------+----------+-----------+---------------
         9 | Смирнов Смир            |     180000 | 2025-09-10  |    2812.50 |           5 |    51250.00 |          1 |   95000.00 |   8.33 |    91.67 |     28.47 |         52.78
         8 | Кузнецов Кузьма         |     160000 | 2025-08-01  |    2800.00 |           6 |    44000.00 |          1 |   60000.00 |   5.63 |    94.38 |     27.50 |         37.50
         4 | Сидорова Мария          |      70000 | 2025-03-10  |    7500.00 |           7 |    23000.00 |          0 |       0.00 |  35.71 |    64.29 |     32.86 |          0.00
         3 | Петров Петр Петрович    |     400000 | 2025-03-01  |    6666.67 |          13 |   212708.33 |          0 |       0.00 |  15.63 |    84.38 |     53.18 |          0.00
         7 | Сидоров Сидор Сидорович |     135000 | 2025-08-15  |    2777.78 |           4 |   115555.56 |          0 |       0.00 |   6.15 |    93.85 |     85.60 |          0.00
         6 | Петров Петр Петрович    |      20000 | 2025-06-20  |    1250.00 |           4 |     5000.00 |          0 |       0.00 |  50.00 |    50.00 |     25.00 |          0.00
(6 rows)
